    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection:
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Nasa-hacked"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/cancer01/Nasa-hacked.git "+system.home+"/Nasa-hacked")
            if os.path.exists(system.home+"/Nasa-hacked/install.aex"):
              os.system("cd "+system.home+"/Nasa-hacked && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Nasa-hacked"):
              ...
              os.system("git clone https://github.com/cancer01/Nasa-hacked.git "+system.home+"/Nasa-hacked")
            if os.path.exists(system.home+"/Nasa-hacked/install.aex"):
              os.system("cd "+system.home+"/Nasa-hacked && sh install.aex")
              if os.path.exists(system.bin+"/Nasa-hacked") and os.path.exists(system.conf_dir+"/Nasa-hacked"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall Nasa-hacked" or cmd=="unistall Nasa-hacked":
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Nasa-hacked")
          os.system(system.sudo+" rm -rf "+system.bin+"/toolx")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Nasa-hacked")
        else:
          os.system("rm -rf "+system.bin+"/Nasa-hacked")
          os.system("rm -rf "+system.bin+"/toolx")
          os.system("rm -rf "+system.conf_dir+"/Nasa-hacked")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Nasa-hacked/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Nasa-hacked/core/cat.json") as cat_file:
