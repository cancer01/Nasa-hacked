...
//     / / /\/___/ // / /___/ /\ \      / / /    \/_/  / /\_______/      / / /    / / // / /___/ /\ \        \ \ \     / / /___/ /\ \   
//    / / /   / / // / /_____/ /\ \    / / /          / / /\ \ \        / / /    / / // / /_____/ /\ \   _    \ \ \   / / /_____/ /\ \  
//   / / /   / / // /_________/\ \ \  / / /________  / / /  \ \ \      / / /    / / // /_________/\ \ \ /_/\__/ / /  / /_________/\ \ \ 
//  / / /   / / // / /_       __\ \_\/ / /_________\/ / /    \ \ \    / / /    / / // / /_       __\ \_\\ \/___/ /  / / /_       __\ \_\
//  \/_/    \/_/ \_\___\     /____/_/\/____________/\/_/      \_\_\   \/_/     \/_/ \_\___\     /____/_/ \_____\/   \_\___\     /____/_/
...
//  $$ |  $$ |   $$ |          $$ |  $$\ $$ |  $$ |$$ |\$$$ |$$  /\$$\ $$ |      $$ |  $$ |
//  $$$$$$$  |   $$ |          \$$$$$$  |$$ |  $$ |$$ | \$$ |$$ /  $$ |$$$$$$$$\ $$ |  $$ |
//  \_______/    \__|           \______/ \__|  \__|\__|  \__|\__|  \__|\________|\__|  \__|  Bang !! Bang !!
//                                                                                         
//                                                                                         
//                                                                                         
...
===============================================\033[00m''')
  ...
  def not_ins(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't install Nasa-Hacked.\033[1;m
...
\033[1;31m If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print ('''
\033[1;33m    [ + ] \033[1;32mNasa-Hacked installed successfully.
\033[1;33m    [ + ] \033[1;32mTo run Nasa-Hacked.
\033[1;33m    [ + ] \033[1;32mType Nasa-Hacked in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print ('''
\033[1;33m  [ 1 ] \033[1;32mUpdate your Nasa-Hacked.
\033[1;33m  [ 0 ] \033[1;32mFor Back.\033[00m''')
  ...
  def updated(self):
    self.tool_header()
    print ('''
\033[1;33m      [ + ] \033[1;32mNasa-Hacked Updated Successfully.
...
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
  ...
  def update_error(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't Update Nasa-Hacked.\033[1;m
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
    self.tool_footer()
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
\033[1;33m       [+] Tool Name :- \033[1;32mNasa-Hacked
...
\033[1;33m [+] \033[1;32mNasa-Hacked is automatic tool installer.
\033[1;33m [+] \033[1;32mMade for termux and linux based system.
\033[1;33m [+] Note :- Use this tool at your own risk.''')
    self.tool_footer()
...
\033[01;33m|  00) Back                                   |
 \033[01;36m=============================================\033[00m""")
  ...
  def updating(self):
    print ("""\033[01;33m =============================================
\033[01;32m|______________ Updating Nasa-Hacked ______________|
 \033[01;33m=============================================\033[00m""")
...
\033[1;33m  [ 3 ] \033[1;32mUpdate Nasa-Hacked.
...
\033[1;33m  [ x ] \033[1;32mFor Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print ('''
\033[1;33m         [ + ] \033[1;32mThanks for using Nasa-Hacked
